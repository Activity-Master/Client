...
- Repository URL / local path: https://github.com/Activity-Master/Client.git
- Org and project name: ActivityMaster / Client Library
- Short description: A Client Library that exposes the FSDM functionality to clients through bounded context interfaces and default enumerations for base system interactivity
