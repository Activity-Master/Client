...
public interface IContainsHierarchy<J extends IWarehouseBaseTable<J, ?, I>, I extends java.util.UUID>
{
  ...
  /**
   * Stateless variant of {@link #archiveChild(Mutiny.StatelessSession, IWarehouseTable, String, String, ISystems, UUID...)}
  ...
  /**
   * Stateless variant of {@link #addChild(Mutiny.StatelessSession, IWarehouseTable, String, String, ISystems, UUID...)}.
   * <p>
