...
public interface IManagePartyIdentificationTypes<J extends IWarehouseBaseTable<J, ?, ? extends Serializable>>
{
    ...
    /**
     * Stateless variant of {@link #addOrUpdateInvolvedPartyIdentificationType(Mutiny.StatelessSession, String, IInvolvedPartyIdentificationType, String, String, ISystems, UUID...)}.
