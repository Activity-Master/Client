...
public interface IManageResourceItemTypes<J extends IWarehouseBaseTable<J, ?, ? extends Serializable>>
{
	...
	/** Stateless variant of {@link #expireResourceItemTypes(Mutiny.StatelessSession, String, String, String, String, ISystems, UUID...)}. */
	...
	/** Stateless variant of {@link #archiveResourceItemTypes(Mutiny.StatelessSession, String, String, String, String, ISystems, UUID...)}. */
	...
	/** Stateless variant of {@link #removeResourceItemTypes(Mutiny.StatelessSession, String, String, String, String, ISystems, UUID...)}. */
	...
	/**
	 * Stateless variant of {@link #updateResourceItemTypes(Mutiny.StatelessSession, String, String, String, String, ISystems, UUID...)}
