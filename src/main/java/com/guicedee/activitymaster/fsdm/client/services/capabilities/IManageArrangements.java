...
public interface IManageArrangements<J extends IWarehouseBaseTable<J, ?, ? extends Serializable>>
{
    ...
    default Uni<IRelationshipValue<J, IArrangement<?, ?>, ?>> addOrUpdateArrangement(Mutiny.StatelessSession session, String classificationValue, IArrangement<?, ?> arrangementType, String searchValue, String storeValue, ISystems<?, ?> system, UUID... identityToken)
    {
     ...
     default io.smallrye.mutiny.Uni<java.util.List<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>>> findArrangementsByClassification(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, String classificationName, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
     ...
     default io.smallrye.mutiny.Uni<java.util.List<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>>> findArrangementsByClassification(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, String arrangementType, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?> withParent, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
         return arrangements.findArrangementsByClassification(session, arrangementType, withParent, value, system, identityToken);
     }

     default io.smallrye.mutiny.Uni<java.util.List<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>>> findArrangementsByClassificationGT(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, String arrangementType, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?> withParent, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
         return arrangements.findArrangementsByClassificationGT(session, arrangementType, withParent, value, system, identityToken);
     }

     default io.smallrye.mutiny.Uni<java.util.List<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>>> findArrangementsByClassificationGTE(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, String arrangementType, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?> withParent, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
         return arrangements.findArrangementsByClassificationGTE(session, arrangementType, withParent, value, system, identityToken);
     }

     default io.smallrye.mutiny.Uni<java.util.List<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>>> findArrangementsByClassificationLT(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, String arrangementType, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?> withParent, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
         return arrangements.findArrangementsByClassificationLT(session, arrangementType, withParent, value, system, identityToken);
     }

     default io.smallrye.mutiny.Uni<java.util.List<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>>> findArrangementsByClassificationLTE(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, String arrangementType, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?> withParent, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
         return arrangements.findArrangementsByClassificationLTE(session, arrangementType, withParent, value, system, identityToken);
     }

     default io.smallrye.mutiny.Uni<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>> findArrangementByResourceItem(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.resourceitem.IResourceItem<?, ?> resourceItem, String classificationName, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
         return arrangements.findArrangementByResourceItem(session, resourceItem, classificationName, value, system, identityToken);
     }

     default io.smallrye.mutiny.Uni<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>> findArrangementByInvolvedParty(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.party.IInvolvedParty<?, ?> involvedParty, String classificationName, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
         return arrangements.findArrangementByInvolvedParty(session, involvedParty, classificationName, value, system, identityToken);
     }

     default io.smallrye.mutiny.Uni<java.util.List<com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.arrangements.IArrangement<?, ?>>> findArrangementsByInvolvedParty(org.hibernate.reactive.mutiny.Mutiny.StatelessSession session, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.party.IInvolvedParty<?, ?> involvedParty, String classificationName, String value, com.guicedee.activitymaster.fsdm.client.services.builders.warehouse.systems.ISystems<?, ?> system, java.util.UUID... identityToken)
     {
         com.guicedee.activitymaster.fsdm.client.services.IArrangementsService<?> arrangements = com.guicedee.client.IGuiceContext.get(com.guicedee.activitymaster.fsdm.client.services.IArrangementsService.class);
